...
##############################################################################################
#   Description:
#       Usage: python file_encrypter.py enc key filename
#       Purpose:    Encrypts and decrypts files using AES for keys of 16, 24, or 32 bytes 
#                   with a 16 byte block size. Includes SHA256 to obfuscate key in file.
##############################################################################################
#   Resources used:
#       A bit of stack overflow, Assignment 1 and 2 from this class (CYEN406).
#
###############################################################################################
import sys
...
# Generate the has of our key
def hash_sha256(data):
    return hashlib.sha256(data.encode('utf8')).hexdigest()

# change to either filename_enc.ext or filename_dec.ext
...
# Neatly contains our AES encryption
